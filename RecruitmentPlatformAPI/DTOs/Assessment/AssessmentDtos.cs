...
namespace RecruitmentPlatformAPI.DTOs.Assessment
{
    ...
    /// <summary>
    /// Response for the eligibility check — determines whether the user can start an
    /// assessment and surfaces the claimed-skills snapshot used for question targeting.
    /// </summary>
    ...
    /// <summary>
    /// Optional request body when starting an assessment.
    ...
    /// <summary>Response returned when an assessment is successfully started.</summary>
    ...
    /// <summary>Current assessment attempt status and progress.</summary>
    public class AssessmentStatusResponseDto
    {
        /// <summary>The assessment attempt ID.</summary>
        public int AttemptId { get; set; }

        /// <summary>Current status string (InProgress, Completed, Abandoned).</summary>
    ...
    /// <summary>A single question presented to the user during an assessment.</summary>
    ...
    /// <summary>
    /// Assessment completion result with skill-based scoring.
    ...
    /// <summary>Summary of a single historical assessment attempt.</summary>
    ...
    /// <summary>Assessment history list response.</summary>
