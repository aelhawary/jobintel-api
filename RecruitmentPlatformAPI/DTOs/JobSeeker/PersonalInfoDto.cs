...
/// <summary>
    ...
    /// </summary>
    public class PersonalInfoRequestDto : IValidatableObject
    {
        // === Primary Attributes ===
    ...
    public class PersonalInfoDto : PersonalInfoRequestDto
    {
        ...
        /// <summary>
        /// ISO 3166-1 alpha-2 country code (e.g. "EG", "US", "GB") used to render the flag on the frontend.
        /// Null when the country record does not have a code.
        /// </summary>
        /// <example>EG</example>
