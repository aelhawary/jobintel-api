            ...
            try
            {
                ...
                if (!isJobSeeker && !isRecruiter)
                {
                    return new AuthResponseDto
                    {
                        ...
                        ErrorCode = AuthErrorCode.InvalidAccountType
                    };
                }
                ...
                else
                {
                    var recruiter = new RecruiterEntity
                    {
                        ...
                        CountryId = null, // To be updated in profile completion
                        CityId = null, // To be updated in profile completion
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(user.PasswordHash))
                {
                    return new AuthResponseDto
                    {
                        ...
                        ErrorCode = AuthErrorCode.OAuthRequired
                    };
                }
                ...
                if (!user.IsActive)
                {
                    return new AuthResponseDto
                    {
                        ...
                        ErrorCode = AuthErrorCode.AccountDeactivated
                    };
                }
            ...
            try
            {
                ...
                if (googleUser == null)
                {
                    return new AuthResponseDto
                    {
                        ...
                        ErrorCode = AuthErrorCode.GoogleTokenInvalid
                    };
                }
                ...
                if (!googleUser.EmailVerified)
                {
                    return new AuthResponseDto
                    {
                        ...
                        ErrorCode = AuthErrorCode.GoogleEmailNotVerified
                    };
                }
                ...
                if (existingUser != null)
                {
                    ...
                    else if (existingUser.AuthProvider == AuthProvider.Google && existingUser.ProviderUserId != googleUser.Sub)
                    {
                        ...
                        return new AuthResponseDto
                        {
                            ...
                            ErrorCode = AuthErrorCode.GoogleAccountMismatch
                        };
                    }
            ...
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(validateDto.Token))
                {
                    return new AuthResponseDto
                    {
                        ...
                        ErrorCode = AuthErrorCode.ResetTokenInvalid
                    };
                }
                ...
                if (passwordReset.ExpiresAt < DateTime.UtcNow)
                {
                    ...
                    return new AuthResponseDto
                    {
                        ...
                        ErrorCode = AuthErrorCode.ResetTokenExpired
                    };
                }
